...
namespace cpuframework
{
    public static class SQLUtility
    {
        ...
        {
            // this connection obj just used to parse conn string not to connect to database
        ...
        //use adapter to call delete sproc with parameter @id set to the right value 
        ...
        public static string GetSQL(System.Data.SqlClient.SqlCommand cmd)
        {
            ...
            if (cmd != null)
            {
                ...
                else
                {
                    ...
                    {
                        //get declare and set of output params
